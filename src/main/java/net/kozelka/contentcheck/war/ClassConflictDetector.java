package net.kozelka.contentcheck.war;
...
//        System.out.println(" : " + key);
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Detecting conflicts in " + war);
        ...
        for (ArchiveInfo cai : sortedConflictingArchives) {
            ...
            for (Conflict conflict : sortedConflicts) {
                ...
                System.out.println(String.format("%8d class conflicts with '%s'", conflict.resources.size(), conflict.otherArchive.getKey()));
        ...
        System.out.println("-------------------------------------------------");
        System.out.println(String.format("Total: %d conflicts affects %d of %d archives.",
                totalConflicts,
